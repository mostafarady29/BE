...
export default function LoginPage() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-linear-to-br from-blue-faint to-surface px-4"
      dir="rtl"
    >
      <div className="w-full max-w-105">
        ...
        <div className="bg-white p-10 rounded-2xl shadow-blue-form border border-gray-100">
          <h2 className="text-2xl font-bold font-amiri text-navy mb-2">
            دخول موظفي المكتب
          </h2>
        ...
        <div className="text-center mt-6">
          <Link
            href="/"
            className="text-sm text-text-muted hover:text-blue transition-colors"
          >
            ← العودة للموقع العام
          </Link>
        </div>
