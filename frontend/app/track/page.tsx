...
export default function TrackPage() {
    ...
    return (
        <>
            <Navbar />
            <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 bg-gradient-to-br from-blue-faint to-surface text-right" dir="rtl">
                <div className="max-w-xl w-full">
                    <div className="text-center mb-8">
                        <div className="text-5xl mb-3">🔍</div>
                        <h1 className="text-3xl font-bold font-amiri mb-2 text-navy">تتبع طلبك</h1>
                        <p className="text-text-secondary">أدخل الرقم القومي ورقم الطلب لمعرفة حالته الحالية</p>
                    </div>

                    <div className="bg-white p-8 rounded-2xl shadow-blue-form border border-border mb-6">
                        <div className="mb-4">
                            <label className="block text-sm font-semibold mb-2">الرقم القومي</label>
                            <input
                                type="text"
                                value={nid}
                        ...
                        <div className="mb-6">
                            <label className="block text-sm font-semibold mb-2">رقم الطلب</label>
                            <input
                                type="number"
                                value={pid}
                    ...
                    {post && (
                        <div className="bg-white p-8 rounded-2xl shadow-blue-form border border-border animate-fade-in">
                            <div className="flex justify-between items-center mb-6 pb-4 border-b border-border">
                                <h3 className="font-bold text-lg font-amiri text-navy">طلب رقم #{post.id}</h3>
                                {getStatusBadge(post.status_name)}
                            </div>

                            <div className="flex justify-between py-2 border-b border-gray-100 text-sm">
                                <span className="text-text-secondary">نوع المشكلة</span>
                                <span className="font-medium text-text-primary max-w-[60%] text-left">{post.problem_type}</span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-gray-100 text-sm">
                                <span className="text-text-secondary">المدينة</span>
                                <span className="font-medium text-text-primary max-w-[60%] text-left">{post.city}</span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-gray-100 text-sm">
                            ...
                            <div className="border-t border-border pt-4">
                                <h4 className="font-semibold mb-2 text-sm text-navy">وصف الطلب</h4>
                            ...
                            <div className="text-center mt-6">
                                <a href="/#request-form" className="text-sm text-blue hover:underline font-semibold">
                                    تقديم طلب جديد
                                </a>
                            </div>
                        </div>
